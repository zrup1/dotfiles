...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ ">_", "www", "chat", "mus", "vid", "vbox", "other"}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "l",     function () awful.util.spawn("lxsession-logout") end,
              {description = "logout prompt", group = "client"}),
...
awful.spawn.with_shell("xrandr --output DP-0 --mode 1920x1080 --rate 239.7")
